...
public static class DatabaseSeeder
{
    ...
    public static async Task SeedAsync(ApplicationDbContext context)
    {
        ...
        foreach (var categorySeed in ProductCatalog)
        {
            var category = await GetOrCreateCategoryAsync(context, categorySeed.Key);
            await SeedProductsAsync(context, category.Id, categorySeed.Value);
        }
    ...
    private static IReadOnlyDictionary<string, IReadOnlyList<SeedProduct>> ProductCatalog =>
        new Dictionary<string, IReadOnlyList<SeedProduct>>
        {
            ["Books"] = BuildGeneratedProducts(
                "Books",
                [
                    "Clean Code Handbook", "Modern Web Architecture", "PostgreSQL Field Guide", "TypeScript Patterns",
                    "ASP.NET Core in Practice", "Design Systems Primer", "Cloud Deployment Notes", "Software Testing Playbook",
                    "Product Management Basics", "Refactoring Workshop", "Database Design Cases", "API Security Guide",
                    "UX Writing Essentials", "Frontend Performance", "Microservices Notes", "Career Journal",
                    "Data Structures Visualized", "Domain Modeling Guide", "Startup Finance Basics", "Leadership Briefs"
                ],
                "A practical paperback edition selected for everyday learning and reference.",
                9.99m,
                "https://images.unsplash.com/photo-1512820790803-83ca734da794?auto=format&fit=crop&w=900&q=80"),
            ["Drinks"] = DrinksProducts!.AsReadOnly(),
            ["Electronics"] = BuildGeneratedProducts(
                "Electronics",
                [
                    "Wireless Noise-Canceling Headphones", "USB-C Fast Charger", "Portable Bluetooth Speaker", "Smart Fitness Band",
                    "Mechanical Keyboard", "Ergonomic Wireless Mouse", "4K Webcam", "Laptop Stand",
                    "Smart LED Desk Lamp", "Compact Power Bank", "Tablet Sleeve", "HDMI Docking Station",
                    "Smart Home Plug", "Wireless Charging Pad", "Action Camera", "Noise-Reducing Earbuds",
                    "Streaming Microphone", "Mini Projector", "Mesh Wi-Fi Node", "E-Reader Light"
                ],
                "Reliable everyday tech with clean design and practical performance.",
                19.99m,
                "https://images.unsplash.com/photo-1498049794561-7780e7231661?auto=format&fit=crop&w=900&q=80"),
            ["Fashion"] = BuildGeneratedProducts(
                "Fashion",
                [
                    "Organic Cotton T-Shirt", "Slim Chino Pants", "Everyday Denim Jacket", "Lightweight Running Hoodie",
                    "Canvas Tote Bag", "Minimal Leather Belt", "Classic White Sneakers", "Merino Wool Socks",
                    "Ribbed Knit Beanie", "Relaxed Oxford Shirt", "Soft Crewneck Sweatshirt", "Waterproof Rain Jacket",
                    "Structured Crossbody Bag", "Athletic Joggers", "Linen Summer Shirt", "Quilted Vest",
                    "Polarized Sunglasses", "Cotton Baseball Cap", "Stretch Training Shorts", "Woven Scarf"
                ],
                "Comfortable wardrobe essentials with a clean modern fit.",
                14.99m,
                "https://images.unsplash.com/photo-1445205170230-053b83016050?auto=format&fit=crop&w=900&q=80"),
            ["Home & Kitchen"] = BuildGeneratedProducts(
                "Home & Kitchen",
                [
                    "Ceramic Dinner Plate Set", "Stainless Steel Saucepan", "Bamboo Cutting Board", "Glass Food Containers",
                    "Cotton Dish Towels", "Pour-Over Coffee Maker", "Digital Kitchen Scale", "Nonstick Frying Pan",
                    "Stoneware Mixing Bowls", "Insulated Travel Mug", "Silicone Spatula Set", "Airtight Pantry Jars",
                    "Chef Knife", "French Press", "Woven Storage Basket", "Scented Soy Candle",
                    "Memory Foam Pillow", "Microfiber Sheet Set", "Compact Air Purifier", "Hand Soap Dispenser"
                ],
                "Useful home and kitchen essentials built for daily routines.",
                7.99m,
                "https://images.unsplash.com/photo-1556911220-bff31c812dba?auto=format&fit=crop&w=900&q=80"),
            ["Salty"] = SaltyProducts!.AsReadOnly(),
            ["Sports"] = BuildGeneratedProducts(
                "Sports",
                [
                    "Yoga Mat", "Stainless Water Bottle", "Resistance Band Set", "Adjustable Jump Rope",
                    "Training Gloves", "Running Waist Pack", "Foam Roller", "Cycling Light Set",
                    "Performance Towel", "Ankle Support Brace", "Grip Strength Trainer", "Balance Board",
                    "Outdoor Soccer Ball", "Basketball", "Tennis Overgrip Pack", "Hiking Daypack",
                    "Quick-Dry Training Shirt", "Compression Calf Sleeves", "Fitness Dice Set", "Trail Cap"
                ],
                "Durable active gear for training, recovery, and outdoor sessions.",
                8.99m,
                "https://images.unsplash.com/photo-1517649763962-0c623066013b?auto=format&fit=crop&w=900&q=80"),
            ["Sweet"] = SweetProducts!.AsReadOnly()
        };

    private static IReadOnlyList<SeedProduct> BuildGeneratedProducts(
        string category,
    ...
    {
        return names
            .Select((name, index) => new SeedProduct(
                name,
                $"{name} from the {category} collection. {descriptionSuffix}",
                basePrice + (index % 10) * 2.35m,
                30 + (index * 7 % 90),
                imageUrl))
            .ToArray();
    }
