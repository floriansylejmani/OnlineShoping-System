      ...
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:p-5">
          ...
          <div className="mt-5 flex flex-col gap-2 sm:max-w-xs">
            <label htmlFor="sort" className="text-xs font-bold uppercase tracking-wide text-slate-500">
              Sort
            </label>
            <select
              id="sort"
              ...
              className="min-h-12 rounded-xl border border-slate-200 bg-slate-50 px-4 text-sm font-semibold text-slate-700 outline-none transition-all duration-300 focus:border-indigo-300 focus:bg-white focus:ring-4 focus:ring-indigo-100"
            >
